...
[discuss with us](https://github.com/singularitti/LagrangeSylvesterInterpolation.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/singularitti/LagrangeSylvesterInterpolation.jl/issues/new) or
[submit a pull request](https://github.com/singularitti/LagrangeSylvesterInterpolation.jl/compare) with suggestions.
